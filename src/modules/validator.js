...
const validator = () => {
    let calcInputs = document.querySelectorAll('.calc-block input[type=text]')
    let formInputs = document.querySelectorAll('form input[type=text], input[placeholder="Ваше сообщение"]')
    let emailInputs = document.querySelectorAll('form input[type=email]')
